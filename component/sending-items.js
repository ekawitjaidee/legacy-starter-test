...
export default function SendingItems({ navigation, code, itemname, serialno, setModalVisible }) {


  return (
    <>
    <View style={{ backgroundColor: "#FFFFFF", borderRadius: 10, marginTop: 10, width: '100%' }}>
